  ...
  return (
    <div className="block-wrap my-[14px] w-full lg:w-auto">
      ...
      <div className="tbl-products">
        <table className=" border-collapse md:mim-w-[500px] w-full">
          <thead>
            <tr>
            ...
            {state?.map((item, index) => (
              <tr key={item.id}>
                ...
                <td className="tbl-data hidden md:table-cell">
                  <div
                    className="bg-[#f0f9ff] text-[#0095ff] flex items-center justify-center border border-[0095ff]
                  rounded-md min-w-[45px] h-6 text-[0.625rem]"
                  >
                    {item.salespercent}
                  </div>
                </td>
